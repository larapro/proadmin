...
namespace Larapro\Proadmin\Commands;

use App\Models\User;
use Illuminate\Console\Command;
use Larapro\Proadmin\Templates\TemplateComponents;
use Larapro\Proadmin\Templates\TemplateDefault;
use Artisan;
...
class ProadminInstall extends Command {
	...
	private function path_package ($path) {
		...
		return base_path("/vendor/larapro/proadmin" . $path);
	}
